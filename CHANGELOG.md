...
All notable changes to the "ContextDo" extension will be documented in this file.
...
The first public release of ContextDo (formerly cursor-contexts)!
...
This initial release establishes ContextDo as a powerful tool for organizing project knowledge and integrating with AI assistants. Key highlights:
...
2. **Install ContextDo**: From marketplace or VSIX
3. **Update settings**: Rename configuration keys:
   - `cursorContexts.*` → `contextdo.*`
...
- 🐛 **Bug Reports**: [GitHub Issues](https://github.com/contextdo/contextdo-vscode/issues)
- 💡 **Feature Requests**: [GitHub Issues](https://github.com/contextdo/contextdo-vscode/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/contextdo/contextdo-vscode/discussions)
- 📖 **Documentation**: [README](https://github.com/contextdo/contextdo-vscode#readme)

---

[Unreleased]: https://github.com/contextdo/contextdo-vscode/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/contextdo/contextdo-vscode/releases/tag/v1.0.0
