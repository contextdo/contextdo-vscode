# Contributing to ContextDo

Thank you for your interest in contributing to ContextDo! 🎉
...
This project and everyone participating in it is governed by the [ContextDo Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to the project maintainers.
...
Before creating bug reports, please check the [issue tracker](https://github.com/contextdo/contextdo-vscode/issues) to avoid duplicates.
...
Look for issues labeled [`good first issue`](https://github.com/contextdo/contextdo-vscode/labels/good%20first%20issue) - these are great for newcomers!

#### What to Work On

- Check [open issues](https://github.com/contextdo/contextdo-vscode/issues)
...
2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR_USERNAME/contextdo-vscode.git
   cd contextdo-vscode
   ```

3. **Add upstream remote**
   ```bash
   git remote add upstream https://github.com/contextdo/contextdo-vscode.git
   ```
...
1. **Install development extension**
   ```bash
   npm run compile
   code --install-extension contextdo-vscode-1.0.0.vsix --force
   ```
...
Thank you for contributing to ContextDo! 🚀
