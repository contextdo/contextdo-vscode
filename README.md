# ContextDo for VS Code

<div align="center">

![ContextDo Logo](resources/icon.png)

**Organize your project knowledge and supercharge your AI assistants**

[![VS Code Marketplace](https://img.shields.io/visual-studio-marketplace/v/cxthub.contextdo-vscode?style=flat-square&label=VS%20Code%20Marketplace&logo=visual-studio-code)](https://marketplace.visualstudio.com/items?itemName=cxthub.contextdo-vscode)
[![Installs](https://img.shields.io/visual-studio-marketplace/i/cxthub.contextdo-vscode?style=flat-square)](https://marketplace.visualstudio.com/items?itemName=cxthub.contextdo-vscode)
[![Rating](https://img.shields.io/visual-studio-marketplace/r/cxthub.contextdo-vscode?style=flat-square)](https://marketplace.visualstudio.com/items?itemName=cxthub.contextdo-vscode)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://opensource.org/licenses/MIT)
[![GitHub issues](https://img.shields.io/github/issues/contextdo/contextdo-vscode?style=flat-square)](https://github.com/contextdo/contextdo-vscode/issues)
...
ContextDo is a powerful VS Code extension that helps you organize project-specific knowledge and seamlessly integrate it with AI assistants like **GitHub Copilot**, **Cursor AI**, and other LLM-powered tools.
...
ContextDo creates organized **context projects** that:
...
# Then install:
code --install-extension contextdo-vscode-1.0.0.vsix

# For Cursor IDE:
cursor --install-extension contextdo-vscode-1.0.0.vsix
```

### From Source

```bash
git clone https://github.com/contextdo/contextdo-vscode.git
cd contextdo-vscode
npm install
npm run compile
vsce package
...
Open the **ContextDo** view in the sidebar (Activity Bar icon) and click **"Create New Project"**.
...
- Press `Cmd+Shift+P`
- Type "ContextDo: Show Project Status"
...
Configure ContextDo in your VS Code settings:

```json
{
  // Folder name for context projects
  "contextdo.contextsFolderName": ".contexts",
  
  // Show welcome message
  "contextdo.showWelcomeMessage": true,
  
  // Auto-sync settings
  "contextdo.autoSync.enabled": true,
  "contextdo.autoSync.intervalMinutes": 60,
  "contextdo.autoSync.notifyOnChanges": true
}
```
...
| Command | Description |
|---------|-------------|
| `ContextDo: Create New Project` | Create a new context project |
| `ContextDo: Clone from GitHub` | Clone a repository as a context project |
| `ContextDo: Show Project Status` | View dashboard of all projects |
| `ContextDo: Show All TODO Tasks` | Scan for TODO/FIXME comments |
| `ContextDo: Show Recent Changes` | View Git commit history |
| `ContextDo: Sync All Projects` | Update all Git repositories |
| `ContextDo: Enable/Disable Project` | Toggle project visibility to AI |
...
Found a bug or have an idea? [Open an issue](https://github.com/contextdo/contextdo-vscode/issues/new)!
...
If ContextDo helps your development workflow:
...
- [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=cxthub.contextdo-vscode)
- [GitHub Repository](https://github.com/contextdo/contextdo-vscode)
- [Issue Tracker](https://github.com/contextdo/contextdo-vscode/issues)
...
![GitHub stars](https://img.shields.io/github/stars/contextdo/contextdo-vscode?style=social)
![GitHub forks](https://img.shields.io/github/forks/contextdo/contextdo-vscode?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/contextdo/contextdo-vscode?style=social)

---

<div align="center">

**Made with ❤️ by the ContextDo Community**

[⬆ Back to Top](#contextdo-for-vs-code)
