# ContextDo Architecture

## Overview

ContextDo is a VS Code extension designed to organize project-specific knowledge and integrate it seamlessly with AI assistants. This document describes the architecture, design decisions, and key components.
